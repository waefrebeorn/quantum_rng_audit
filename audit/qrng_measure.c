 ...
 * string. It prints the Shannon entropy of the actual generated stream, which is
 * what qrng_get_entropy_estimate() now returns (a real measurement of the output,
 * not the previously-broken internal-pool estimator). Expect ~7.9-8.0 bits/byte.
 *
 ...
 *   /tmp/qrng_measure
 *
 * NOTE: an older revision of this comment referenced ../src/common/secure_memory.c
 * and wrong -I paths. That file was never part of this fork; the core compiles
 * standalone from src/quantum_rng/quantum_rng.c.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    ...
    /* Honest pass criteria: entropy should be near the 8 bits/byte max (the core
       now measures the real Shannon entropy of the output stream, ~7.9-8.0), and the
